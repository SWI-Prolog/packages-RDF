...
\begin{abstract}
\href{http://www.w3.org/RDF/}{RDF} ({\bf R}esource {\bf D}escription {\bf
F}ormat) is a \href{http://www.w3.org/}{W3C} standard for expressing
...
the \href{http://www.w3.org/TR/REC-rdf-syntax/}{specification}, so
...
\section{Predicates for parsing RDF/XML}
\label{sec:rdfxml-predicates}
...
described with the SWI-Prolog
\href{http://www.swi-prolog.org/packages/sgml2pl.html}{SGML/XML parser}.
...
extended by the user. For example, to parse the
\href{http://www.mozilla.org/rdf/doc/inference.html}{Netscape
OpenDirectory}
...
\href{http://www.smi.stanford.edu/projects/protege/}{Protege-2000} and
...
Prolog startup time to process this file. The
\href{http://www.pro-solutions.com/rdfdemo/}{Pro Solutions} parser
